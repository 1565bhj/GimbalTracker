/***
    ...
    *************** 极客电子************
   ************************************************************************************************
	*	淘宝地址 https://shop252966792.taobao.com
...
//   hdma_dcmi.Instance                     = DMA1_Stream0;               // DMA1数据流0     
...
//	
//   HAL_NVIC_SetPriority(DMA1_Stream0_IRQn, 0, 0);         // 设置中断优先级
...
*               则 DMA_BufferSize = 115200 / 4 = 28800 数据单元。
*fanke
*****************************************************************************************************************************************/
